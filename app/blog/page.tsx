...
const BlogPage: React.FC = () => {
  ...
  const blogPosts: BlogPost[] = [
    {
      ...
      excerpt:
        "Discover expert tips and tricks for securing the perfect hotel accommodation, ensuring your comfort and satisfaction wherever you travel.",
    ...
    },
    {
      ...
      excerpt:
        "Learn how our accelerated admission processing can help you achieve your dream of studying abroad without the usual waiting times.",
      content: "Full content here...",
      author: "Ebony Bruce",
      authorTitle: "Admin",
      authorImage: "/images/logo1.png",
    ...
    },
    {
      ...
      excerpt:
        "A comprehensive guide to understanding our DHL logistics services and how they can streamline your international shipping needs.",
      content: "Full content here...",
      author: "Ebony Bruce",
      authorTitle: "Admin",
      authorImage: "/images/logo1.png",
    ...
    },
    {
      ...
      excerpt:
        "From historic landmarks to hidden local favorites, discover the best cultural experiences the United Kingdom has to offer.",
      content: "Full content here...",
      author: "Ebony Bruce",
      authorTitle: "Admin",
      authorImage: "/images/logo1.png",
    ...
    },
    {
      ...
      excerpt:
        "Everything you need to know before embarking on your international education adventure, from visa requirements to cultural adaptation.",
      content: "Full content here...",
      author: "Ebony Bruce",
      authorTitle: "Admin",
      authorImage: "/images/logo1.png",
    ...
    },
    {
      ...
      excerpt:
        "Learn how to explore the world without breaking the bank with our expert budget travel tips and money-saving strategies.",
      content: "Full content here...",
      author: "Ebony Bruce",
      authorTitle: "Admin",
      authorImage: "/images/logo1.png",
  ...
  const categories = [
    { id: "all", name: "All Posts", count: blogPosts.length },
    {
      id: "Travel Tips",
      name: "Travel Tips",
      count: blogPosts.filter((p) => p.category === "Travel Tips").length,
    },
    {
      id: "Education",
      name: "Education",
    ...
    },
    {
      id: "Logistics",
      name: "Logistics",
      count: blogPosts.filter((p) => p.category === "Logistics").length,
    },
    {
      id: "Destination Guides",
      name: "Destination Guides",
      count: blogPosts.filter((p) => p.category === "Destination Guides")
        .length,
    },
  ];
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-[#001f3f] to-[#002b4f] text-white py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-6">
            Ebony Bruce Travels <span className="text-[#33a8da]">Blog</span>
          </h1>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Insights, guides, and stories from your trusted partner in travel,
              ...
              >
                ...
                <div className="p-8">
                  <div className="flex items-center gap-4 mb-4">
                    <span className="text-sm font-semibold text-[#33a8da] uppercase tracking-wider">
                      {post.category}
                    </span>
              ...
              >
                ...
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-xs font-bold text-[#33a8da] uppercase tracking-wider">
                      {post.category}
                    </span>
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-black text-[#001f3f] mb-4 tracking-tight">
            Stay Updated
          </h2>
          <p className="text-gray-600 mb-8">
            Subscribe to our newsletter for the latest travel tips, educational
