...
// Helper function to safely get text from description
...
export default function HotelDetailsPage() {
  ...
  useEffect(() => {
    ...
    if (storedData) {
      try {
        ...
        const enriched = {
          ...
          // ✅ Fix description - ensure it's a string
          description: getDescriptionText(parsed.description),
          realData: {
            ...parsed.realData,
    ...
    if (selectedItem) {
      ...
      // ✅ Fix description - ensure it's a string
      const description = getDescriptionText(itemAny.description) || 
                         getDescriptionText(hotelData.description) || 
                         itemAny.subtitle || 
                         '';
      ...
      const enriched = {
        ...
        hotel: {
          ...
          description: getDescriptionText(hotelData.description),
  ...
  const handleBook = useCallback(() => {
    ...
    const hotelForBooking = {
      ...
      // ✅ Fix description - ensure it's a string
      description: getDescriptionText(itemToUse.description) || itemToUse.subtitle || '',
