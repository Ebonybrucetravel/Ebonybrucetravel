...
/** True when this hotel uses the Amadeus flow (card sent with booking, then margin paid via Stripe). */
function isAmadeusHotel(item: { type?: string; realData?: { offerId?: string; finalPrice?: number; price?: number } }): boolean {
  ...
  if (!selectedItem) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-gray-600 mb-8">Please select an item to book first.</p>
