...
const CarRentals: React.FC = () => {
  ...
  const brandBlue = '#32A6D7'; // Your requested color
  ...
  return (
    <section className="px-4 md:px-8 lg:px-16 py-12 bg-white">
      <div className="flex justify-between items-end mb-8 md:mb-10">
        ...
        <a 
          href="#" 
          className={`text-[${brandBlue}] font-semibold hover:text-[#2a8bb5] text-base md:text-lg flex items-center gap-2 group transition-colors`}
        >
          See More
