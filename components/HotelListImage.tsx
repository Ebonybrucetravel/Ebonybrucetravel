...
export function HotelListImage({ hotelId, hotelName, fallbackSrc = FALLBACK_HOTEL, alt, className, }: HotelListImageProps) {
    ...
    return (<div ref={ref} className={className ? `block ${className}` : 'block w-full h-full'}>
      <img src={src} alt={alt} className="w-full h-full object-cover group-hover:scale-110 transition duration-500"/>
    </div>);
}
