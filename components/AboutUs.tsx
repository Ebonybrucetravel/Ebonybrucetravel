    ...
    return (<div className="bg-white min-h-screen animate-in fade-in duration-500">
      ...
      <section className="max-w-7xl mx-auto px-6 py-32 text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          {team.map((member) => (<div key={member.name} className="group">
      ...
      <section className="bg-gray-50/50 py-32">
        <div className="max-w-7xl mx-auto px-6 text-center">
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 text-left">
              {blogPosts.map((post) => (<div key={post.title} className="bg-white rounded-[24px] overflow-hidden shadow-sm border border-gray-100 group">
