...
const SpecializedServices: React.FC<SpecializedServicesProps> = ({
  onServiceClick,
}) => {
  const { t } = useLanguage();
          ...
          <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-blue-200 transition">
            ...
            >
              <path
                ...
                strokeWidth={2}
                d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 002 2h1.5a2.5 2.5 0 012.5 2.5V14a2 2 0 002 2h.5m-2-12h1.5a2 2 0 012 2v.5a2 2 0 01-2 2h-1a2 2 0 00-2 2v1a2 2 0 01-2 2h-1a2 2 0 00-2 2v1a2 2 0 01-2 2h-1"
              />
            </svg>
          </div>
