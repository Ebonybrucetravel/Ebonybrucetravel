...
const SpecializedServices: React.FC = () => {
  ...
  return (
    <section className="text-center py-12">
      <div className="mb-12">
        <h2 className="text-3xl font-bold text-gray-900 mb-4">{t('Our Services')}</h2>
        <p className="text-gray-500 max-w-2xl mx-auto">
          {t('We offer more than just bookings.')}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-4">{t('International and Local Logistics')}</h3>
          <p className="text-gray-500 text-sm mb-6">
            Global shipping and localized logistics services powered by our official DHL franchise partnership.
          </p>
          <a href="#" className="text-blue-600 font-bold text-sm hover:underline">{t('Learn More')}</a>
        </div>
        ...
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group scale-105 z-10">
          ...
          <h3 className="text-xl font-bold text-gray-900 mb-4">{t('Educational Consultancy')}</h3>
          <p className="text-gray-500 text-sm mb-6">
