    ...
    <section className="text-center py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
          ...
          <button 
            onClick={() => onServiceClick?.('DHL Logistics')}
            className="text-blue-600 font-bold text-sm hover:underline border-none bg-transparent cursor-pointer"
          >
        ...
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group scale-105 z-10">
          ...
          <button 
            onClick={() => onServiceClick?.('Admission Processing')}
            className="text-blue-600 font-bold text-sm hover:underline border-none bg-transparent cursor-pointer"
          >
            {t('services.learnMore')}
          </button>
        ...
        <div className="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl transition-all group">
          ...
          <button 
            onClick={() => onServiceClick?.('Curated Tours')}
            className="text-blue-600 font-bold text-sm hover:underline border-none bg-transparent cursor-pointer"
          >
            {t('services.learnMore')}
          </button>
