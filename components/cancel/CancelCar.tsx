...
export default function CancelCarPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const carData = {
    ...
    pickupDateTime: booking.pickupDateTime || booking.bookingData?.pickupDateTime,
  ...
  const currencySymbol = carData.price.match(/[£$€₦]/)?.[0] || '£';
          ...
          <div className="p-8 md:p-10 space-y-8">
            <div className="flex flex-col md:flex-row gap-8">
              <div className="w-full md:w-64 h-48 bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl flex items-center justify-center p-6">
                <img 
                  src={booking.image || 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2'} 
                  alt={carData.vehicle}
