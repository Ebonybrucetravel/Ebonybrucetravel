  ...
  return (
    <section className="bg-white py-24">
      <div className="max-w-4xl mx-auto px-4 text-center">
        <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4">{t('newsletter.title')}</h2>
        <p className="text-gray-500 mb-10 tracking-widest text-sm font-bold uppercase">{t('newsletter.subtitle')}</p>
