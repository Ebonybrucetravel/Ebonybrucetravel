      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="flex-1 space-y-10">
            <section className="bg-white rounded-[32px] p-10 shadow-sm border border-gray-100">
              <div className="flex items-center gap-3 mb-10">
                ...
                <h2 className="text-xl font-black text-gray-900 tracking-tight">Traveler Information</h2>
              </div>
              
              {!isLoggedIn && (
                <div className="bg-gray-50 border-2 border-dashed border-gray-200 rounded-2xl p-8 text-center mb-10">
              ...
              <div className="space-y-8">
                <div>
                  <label className="block text-[11px] font-black text-gray-900 uppercase tracking-widest mb-3">Ful Name</label>
                  <input type="text" defaultValue={isLoggedIn ? user?.name : 'Ebony Life'} className="w-full px-6 py-4 bg-gray-50 border-none rounded-xl font-bold text-gray-900 focus:bg-white focus:ring-2 focus:ring-[#33a8da]/10 transition-all" />
                </div>
                <div>
                  <label className="block text-[11px] font-black text-gray-900 uppercase tracking-widest mb-3">Email Address</label>
                  <input type="email" defaultValue={isLoggedIn ? user?.email : ''} placeholder="Enter your email adsress" className="w-full px-6 py-4 bg-gray-50 border-none rounded-xl font-bold text-gray-900 focus:bg-white focus:ring-2 focus:ring-[#33a8da]/10 transition-all" />
                </div>
              </div>
            </section>
            ...
            <section className="bg-white rounded-[32px] p-10 shadow-sm border border-gray-100">
              ...
              <div className="space-y-3">
                <label className={`flex items-center justify-between p-6 border-2 rounded-2xl cursor-pointer transition-all ${paymentMethod === 'wallet' ? 'border-[#33a8da] bg-blue-50/10' : 'border-gray-50 hover:border-gray-100'}`}>
                  <div className="flex items-center gap-4">
                    <input type="radio" checked={paymentMethod === 'wallet'} onChange={() => setPaymentMethod('wallet')} className="w-5 h-5 accent-[#33a8da]" />
                    <span className="font-bold text-gray-700">Ebony Bruce Wallet (NGN 220,000)</span>
                  </div>
                </label>
                <label className={`flex items-center justify-between p-6 border-2 rounded-2xl cursor-pointer transition-all ${paymentMethod === 'card' ? 'border-[#33a8da] bg-blue-50/10' : 'border-gray-50 hover:border-gray-100'}`}>
                  <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-2">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/d/d6/Visa_2021.svg" className="h-4 w-auto grayscale" alt="Visa" />
                    <img src="https://upload.wikimedia.org/wikipedia/commons/2/2a/Mastercard-logo.svg" className="h-4 w-auto grayscale" alt="Mastercard" />
                  </div>
                </label>
                <label className={`flex items-center justify-between p-6 border-2 rounded-2xl cursor-pointer transition-all ${paymentMethod === 'bank' ? 'border-[#33a8da] bg-blue-50/10' : 'border-gray-50 hover:border-gray-100'}`}>
                  <div className="flex items-center gap-4">
          ...
          <aside className="w-full lg:w-[420px]">
            <div className="sticky top-24 bg-white rounded-[32px] shadow-sm border border-gray-100 overflow-hidden">
              <div className="p-10 border-b border-gray-50">
                <h3 className="text-xl font-black text-gray-900 mb-10 tracking-tight uppercase">Flight Summary</h3>
                <div className="flex items-center gap-4 mb-10">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Powered by • Economy</p>
                  </div>
                </div>
                <div className="relative pl-8">
                  <div className="absolute left-[3px] top-[10px] bottom-[10px] w-[1px] bg-gray-200"></div>
                  <div className="relative mb-12">
                    <div className="absolute -left-[33px] top-1.5 w-2 h-2 rounded-full border border-gray-400 bg-white z-10"></div>
                    <div className="flex justify-between items-start">
                      <div>
                        <p className="font-black text-gray-900 text-sm">{item.time || '08:00AM'}</p>
                        <p className="text-[11px] font-black text-gray-400 uppercase">{originCode} ({origin})</p>
                        <p className="text-[10px] text-gray-400 font-bold mt-1">Dec 26, Fri</p>
                      </div>
                      <div className="bg-gray-100 text-gray-400 text-[9px] font-black px-2 py-0.5 rounded uppercase mt-1">1h 15m</div>
                    </div>
                  </div>
                  <div className="relative">
                    <div className="absolute -left-[33px] top-1.5 w-2 h-2 rounded-full bg-gray-900 z-10"></div>
                    <div>
                      <p className="font-black text-gray-900 text-sm">09:15AM</p>
                      <p className="text-[11px] font-black text-gray-400 uppercase">{destCode} ({destination})</p>
                      <p className="text-[10px] text-gray-400 font-bold mt-1">Dec 26, Fri</p>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-10 space-y-6">
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-900 font-black">Base Fare</span>
                  <span className="text-[#33a8da] font-black">NGN 75,000</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-900 font-black">Taxes & Fees</span>
                  <span className="text-[#33a8da] font-black">Included</span>
                </div>
                <div className="flex justify-between items-center text-sm">
                  <span className="text-gray-900 font-black">Baggage</span>
                  <span className="text-[#33a8da] font-black">Free</span>
                </div>
                ...
                <button 
                  ...
                  disabled={isBooking}
                  className="w-full bg-[#33a8da] text-white font-black py-5 rounded-2xl shadow-xl shadow-blue-500/20 hover:bg-[#2c98c7] transition transform active:scale-95 text-lg"
                >
                  {isBooking ? 'Processing...' : 'Complete Booking'}
                </button>
                <button onClick={() => setView('review')} className="w-full text-center text-[#33a8da] text-[11px] font-black uppercase tracking-widest mt-4 hover:underline">Cancel & Return</button>
              </div>
              <div className="m-8 p-8 bg-gray-50 rounded-[20px]">
