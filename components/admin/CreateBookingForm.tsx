...
export default function CreateBookingForm({ onBack, onCreateBooking, users = [] }: CreateBookingFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const newBooking = {
      ...
      customerEmail: createBookingData.customerEmail,
      price: price,
      ...
      paymentMethod,
      baggage: createBookingData.baggage,
      taxesFees: createBookingData.taxesFees,
      baseFare: createBookingData.baseFare
    };
